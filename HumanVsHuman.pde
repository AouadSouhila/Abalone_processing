...
public void setup() {
  ...
  roleChipsInterface.add(new Marble(50, 50, 1));   bhome =new Button(100,500,200,80,50,color(255),"Home" ,170,550);
...
checkScore();if(endGame && bhome.clicked() ){home=new homePage();home.setup(); endGame=false;} 
